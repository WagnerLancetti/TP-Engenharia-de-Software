...
class Menu():
    def MenuVisao(self):
        ...
        while (self.saida):
            ...
            Radiobutton(self.Container3, text = "Entrar como Professor", variable = self.valor, value = 2, bg = self.corBack,font = ("Arial","12")).pack()
            Radiobutton(self.Container3, text = "Entrar como Chefe", variable = self.valor, value = 3, bg = self.corBack,font = ("Arial","12")).pack()
            # Botao de Confirmar
